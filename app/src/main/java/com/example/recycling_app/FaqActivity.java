...
import com.example.recycling_app.RetrofitClient; // Retrofit 클라이언트 (API 서비스 인스턴스 생성)
import com.example.recycling_app.FaqAdapter; // FaqAdapter 클래스 (RecyclerView의 어댑터)
